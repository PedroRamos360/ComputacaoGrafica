...
void CV::circle(Vector2 center, float radius, int div)
{
  CV::circle(center.x, center.y, radius, div);
}
...
void CV::circleFill(Vector2 center, float radius, int div)
{
  CV::circleFill(center.x, center.y, radius, div);
}
